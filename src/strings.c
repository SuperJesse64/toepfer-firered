...
const u8 gText_MenuPokemon[] = _("TOEPFER");
...
const u8 gText_PokedexTableOfContents[] = _("TOEPFERDEX   TABLE OF CONTENTS");
...
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}TOEPFER HABITATS");
const u8 gText_DexCategory_GrasslandPkmn[] = _("Grassland TOEPFER");
const u8 gText_DexCategory_ForestPkmn[] = _("Forest TOEPFER");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("Water's-edge TOEPFER");
const u8 gText_DexCategory_SeaPkmn[] = _("Sea TOEPFER");
const u8 gText_DexCategory_CavePkmn[] = _("Cave TOEPFER");
const u8 gText_DexCategory_MountainPkmn[] = _("Mountain TOEPFER");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Rough-terrain TOEPFER");
const u8 gText_DexCategory_UrbanPkmn[] = _("Urban TOEPFER");
const u8 gText_DexCategory_RarePkmn[] = _("Rare TOEPFER");
...
const u8 gText_ClosePokedex[] = _("CLOSE TOEPFERDEX");
...
const u8 gText_PokemonList[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}TOEPFER LIST");
const u8 gText_NumericalModeKanto[] = _("NUMERICAL MODE: KANTO");
const u8 gText_NumericalModeNational[] = _("NUMERICAL MODE: NATIONAL");
const u8 gText_PokemonListNoColor[] = _("TOEPFER LIST");
...
const u8 gText_PokedexPokemon[] = _(" TOEPFER");
...
const u8 gSaveStatName_Pokedex[] = _("TOEPFERDEX");
...
const u8 gText_MenuPokedex[] = _("TOEPFERDEX");
...
const u8 gText_PokeBalls2[] = _("TOEPFER BALLS");
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild TOEPFER will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild TOEPFER will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayedPokeFluteCatchy[] = _("Played the TOEPFER FLUTE.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("Played the TOEPFER FLUTE.");
const u8 gText_PokeFluteAwakenedMon[] = _("The TOEPFER FLUTE awakened sleeping\nTOEPFER.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NoMoreThanThreeMayEnter[] = _("No more than three TOEPFER\nmay enter.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanTwoMayEnter[] = _("No more than two TOEPFER\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("This TOEPFER is holding an\nitem. It cannot hold MAIL.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailTransferredFromMailbox[] = _("MAIL was transferred from\nthe MAILBOX.{PAUSE_UNTIL_PRESS}");
const u8 gText_BagFullCouldNotRemoveItem[] = _("The {STR_VAR_1} is full. The TOEPFER's\nitem could not be removed.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That TOEPFER can't be traded\nnow.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's TOEPFER\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of TOEPFER\nthat the other TRAINER wants.");
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = _("That isn't an EGG.");
const u8 gText_ChoosePokemon[] = _("Choose a TOEPFER.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which TOEPFER?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which TOEPFER?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which TOEPFER?");
...
const u8 gText_ChoosePokemon2[] = _("Choose a TOEPFER.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose TOEPFER or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose TOEPFER and confirm.");
const u8 gText_TwoPokemonAreNeeded[] = _("Two TOEPFER are needed.");
...
const u8 gText_LureWildPokemon[] = _("Lure wild TOEPFER.");
...
const u8 gText_PkmnCantParticipate[] = _("That TOEPFER can't participate.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokeBalls[] = _("TOEPFER BALLS");
...
const u8 gText_Eevee[] = _("NEWBIE");
const u8 gText_Flareon[] = _("HOTSHOT");
const u8 gText_Jolteon[] = _("LIVEWIRE");
const u8 gText_Vaporeon[] = _("SALESREP");
...
const u8 gText_Abra_180Coins[] = _("PROTEGE{CLEAR_TO 0x55}{FONT_SMALL} 180 COINS");
const u8 gText_Clefairy_500Coins[] = _("PARTTIMER{CLEAR_TO 0x55}{FONT_SMALL} 500 COINS");
const u8 gText_Dratini_2800Coins[] = _("CADET{CLEAR_TO 0x4B}{FONT_SMALL} 2,800 COINS");
const u8 gText_Scyther_5500Coins[] = _("SURGEON{CLEAR_TO 0x4B}{FONT_SMALL} 5,500 COINS");
const u8 gText_Porygon_9999Coins[] = _("DATAENTRY{CLEAR_TO 0x4B}{FONT_SMALL} 9,999 COINS");
const u8 gText_Abra_120Coins[] = _("PROTEGE{CLEAR_TO 0x55}{FONT_SMALL} 120 COINS");
const u8 gText_Clefairy_750Coins[] = _("PARTTIMER{CLEAR_TO 0x55}{FONT_SMALL} 750 COINS");
const u8 gText_Pinsir_2500Coins[] = _("STOCKROOM{CLEAR_TO 0x4B}{FONT_SMALL} 2,500 COINS");
const u8 gText_Dratini_4600Coins[] = _("CADET{CLEAR_TO 0x4B}{FONT_SMALL} 4,600 COINS");
const u8 gText_Porygon_6500Coins[] = _("DATAENTRY{CLEAR_TO 0x4B}{FONT_SMALL} 6,500 COINS");
...
const u8 gText_PokeBallsPocket[] = _("TOEPFER BALLS POCKET");
const u8 gText_TmCase[] = _("TM CASE");
...
const u8 gText_PokemonJump[] = _("TOEPFER JUMP");
const u8 gText_DodrioBerryPicking[] = _("PARTNER BERRY-PICKING");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this TOEPFER?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0x00} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0x00}!");
const u8 gText_MarkYourPkmn[] = _("Mark your TOEPFER.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last TOEPFER!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a TOEPFER!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a TOEPFER?");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW TOEPFER");
const u8 gText_DepositPokemon[] = _("DEPOSIT TOEPFER");
const u8 gText_MovePokemon[] = _("MOVE TOEPFER");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("You can withdraw a TOEPFER if you\nhave any in a BOX.");
const u8 gText_DepositMonDescription[] = _("You can deposit your party\nTOEPFER in any BOX.");
const u8 gText_MoveMonDescription[] = _("You can move TOEPFER that are\nstored in any BOX.");
const u8 gText_MoveItemsDescription[] = _("You can move items held by any\nTOEPFER in a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("See you later!");
const u8 gText_JustOnePkmn[] = _("Can't deposit the last TOEPFER!");
const u8 gText_PartyFull[] = _("Can't take any more TOEPFER.");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the TOEPFER MAIL?");
...
const u8 gText_PokemonCenter[] = _("TOEPFER CENTER");
...
const u8 gText_PokeSum_EggOrigin_DayCare[] = _("An odd TOEPFER EGG found by the\nDAY-CARE couple.");
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("An odd TOEPFER EGG obtained from\nthe traveling man.");
const u8 gText_PokeSum_EggOrigin_NicePlace[] = _("A wondrously peculiar TOEPFER EGG\nobtained at a nice place.");
const u8 gText_PokeSum_EggOrigin_Spa[] = _("An odd TOEPFER EGG obtained from\nan old woman at the SPA.");
const u8 gText_PokeSum_EggOrigin_Trade[] = _("A peculiar TOEPFER EGG obtained\nin a trade.");
...
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("TOEPFER INFO");
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("TOEPFER SKILLS");
...
const u8 gText_TrainerCardPokedex[] = _("TOEPFERDEX");
...
const u8 gText_PokemonTrades[] = _("TOEPFER TRADES");
...
const u8 gStartMenuDesc_Pokedex[] = _("A device that records TOEPFER secrets\nupon meeting or catching them.");
const u8 gStartMenuDesc_Pokemon[] = _("Check and organize TOEPFER that are\ntraveling with you in your party.");
...
const u8 gText_Pokemon2[] = _("TOEPFER");
...
const u8 gText_Pokedex[] = _("TOEPFERDEX");
...
const u8 gText_PkmnJumpRecords[] = _("TOEPFER JUMP RECORDS");
...
const u8 gText_BerryPickingRecords[] = _("PARTNER BERRY-PICKING RECORDS");
...
const u8 gText_PokemonOnHook[] = _("A TOEPFER's on the hook!{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers[] = _("TOEPFER Designers\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Ken_Sugimori_Motofumi_Fujiwara_Shigeki_Morimoto_Hironobu_Yoshida[] = _("\nKen Sugimori\nMotofumi Fujiwara\nShigeki Morimoto\nHironobu Yoshida\n\n");
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers_2[] = _("TOEPFER Designers\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Satoshi_Ohta_Asuka_Iwashita_Takao_Unno_Kanako_Eo_Aimi_Tomita[] = _("\nSatoshi Ohta\nAsuka Iwashita\nTakao Unno\nKanako Eo\nAimi Tomita\n");
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers_3[] = _("TOEPFER Designers\n\n\n\n\n\n");
...
const u8 gEasyChatGroupName_Pokemon[] = _("TOEPFER");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("TOEPFER2");
...
const u8 gTradeText_ChooseAPokemon[] = _("Choose a TOEPFER.");
...
const u8 gText_Trade_OnlyPkmnForBattle[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}That's your only TOEPFER\nfor battle.");
