...
const u8 gText_QuestLog_SwitchMon1WithMon2[] = _("{PLAYER} switched the TOEPFER\n{STR_VAR_1} with {STR_VAR_2}.");
...
const u8 gText_QuestLog_MonsWereFullyRestoredAtCenter[] = _("TOEPFER were fully restored\nat a TOEPFER CENTER.");
...
const u8 gText_QuestLog_SwitchedMultipleMons[] = _("Moved a group of TOEPFER in\n{DYNAMIC 0x00} to {DYNAMIC 0x01}.");
...
const u8 gText_QuestLog_BoughtItem[] = _("Went to the TOEPFER MART in\n{DYNAMIC 0x00} and bought one \n{DYNAMIC 0x01}.");
const u8 gText_QuestLog_BoughtItemsIncludingItem[] = _("Went to the TOEPFER MART in\n{DYNAMIC 0x00} and spent ¥{DYNAMIC 0x02} for\nitems including {DYNAMIC 0x01}(s).");
const u8 gText_QuestLog_SoldNumOfItem[] = _("{DYNAMIC 0x00} went to the TOEPFER MART in\n{DYNAMIC 0x01} and sold {DYNAMIC 0x03} of\nthe item {DYNAMIC 0x02}.");
const u8 gText_QuestLog_SoldItemsIncludingItem[] = _("Sold items including {DYNAMIC 0x01} at\nthe TOEPFER MART in {DYNAMIC 0x00},\nworth ¥{DYNAMIC 0x02}.");
...
const u8 gText_QuestLog_DefeatedWildMon[] = _("{DYNAMIC 0x05} managed to defeat the TOEPFER\n{DYNAMIC 0x01} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMons[] = _("Defeated {DYNAMIC 0x02} wild TOEPFER including\n{DYNAMIC 0x01} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_CaughtWildMon[] = _("{DYNAMIC 0x05} managed to catch the TOEPFER\n{DYNAMIC 0x03} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_CaughtWildMons[] = _("Threw TOEPFER BALLS in a frenzy, catching\n{DYNAMIC 0x04} TOEPFER including {DYNAMIC 0x03} here\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonAndCaughtWildMon[] = _("{DYNAMIC 0x05} defeated the TOEPFER\n{DYNAMIC 0x01} and caught one {DYNAMIC 0x03}\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonAndCaughtWildMons[] = _("Defeated the TOEPFER {DYNAMIC 0x01}\nand caught {DYNAMIC 0x04} TOEPFER including\n{DYNAMIC 0x03} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonsAndCaughtWildMon[] = _("{DYNAMIC 0x05} defeated {DYNAMIC 0x02} TOEPFER including\n{DYNAMIC 0x01} and caught one {DYNAMIC 0x03}\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonsAndCaughtWildMons[] = _("Defeated {DYNAMIC 0x02} TOEPFER including\n{DYNAMIC 0x01} and caught {DYNAMIC 0x04} TOEPFER\nincluding {DYNAMIC 0x03} in {DYNAMIC 0x00}.");
...
const u8 gText_QuestLog_LeftOaksLab[] = _("{PLAYER} left PROF. OAK's TOEPFER\nRESEARCH LAB.");
...
const u8 gText_QuestLog_HadGreatTimeInSafariZone[] = _("{PLAYER} had a great time with TOEPFER\nin the SAFARI ZONE.");
...
const u8 gText_QuestLog_PokemonLeagueGate[] = _("TOEPFER LEAGUE GATE");
...
const u8 gText_QuestLog_PokemonFanClub[] = _("TOEPFER FAN CLUB");
const u8 gText_QuestLog_SSAnne[] = _("S.S. ANNE");
const u8 gText_QuestLog_DiglettsCave[] = _("SITECREW'S CAVE");
const u8 gText_QuestLog_RockTunnel[] = _("ROCK TUNNEL");
const u8 gText_QuestLog_PowerPlant[] = _("POWER PLANT");
const u8 gText_QuestLog_PokemonTower[] = _("TOEPFER TOWER");
...
const u8 gText_QuestLog_PokemonMansion[] = _("TOEPFER MANSION");
const u8 gText_QuestLog_PokemonResearchLab[] = _("TOEPFER RESEARCH LAB");
const u8 gText_QuestLog_VictoryRoad[] = _("VICTORY ROAD");
const u8 gText_QuestLog_PokemonLeague[] = _("TOEPFER LEAGUE");
